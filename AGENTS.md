...
- If a feature-lane merge conflicts, verification fails, signing/device install is blocked, or another phone build is already underway, stop with a clear blocker instead of half-merging.

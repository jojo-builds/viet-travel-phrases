# SpeakLocal v2.2 BATCH_015 RECOVERY - Da Nang - 2026-05-26
...
Set `batch_id: batch_015_recovery` in the final handoff block. Put `SpeakLocal v2.2 BATCH_015 RECOVERY - Da Nang - 2026-05-26` as the first line of the final answer so Codex can identify this session later.

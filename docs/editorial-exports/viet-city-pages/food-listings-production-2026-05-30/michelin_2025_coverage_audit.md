...
The city inventory contract is now 507 noun/place pages total: HCMC carries 104 rows, Hanoi carries 102 rows, Da Nang carries 101 rows, and Hội An and Hue remain at 100 rows each.
...
The expansion packets widened the contract explicitly instead of adding loose extra JSON rows. Use `saveworthy_restaurant_add_path_2026-05-31.md` and `production_readiness_review.md` for the source, runtime, validation, and render gates that proved the Mặn Mòi, Bò Kho Gánh, Bún Bò Huế 14B, Phở Lệ, Bánh Cuốn Bà Hoành, Bún Riêu Cua 39, and Phở Gà Nguyệt additive pilots.

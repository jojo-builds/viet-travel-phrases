...
Adding a missing restaurant is not currently a one-object edit. The city inventory is fixed at 500 noun/place pages: 100 per city. The current importer validates that shape before projecting V2.2 copy into the legacy-compatible runtime.

...
For the additive pilots so far, Jojo chose the expansion path. The runtime shape was widened deliberately: HCMC now carries 104 noun/place rows, Hanoi carries 103, Da Nang carries 105, and Hội An and Hue remain at 100 each, for 512 total city places.

That makes Mặn Mòi, Bò Kho Gánh, Bún Bò Huế 14B, Phở Lệ, Bánh Cuốn Bà Hoành, Bún Riêu Cua 39, Phở Gà Nguyệt, Phở 10 Lý Quốc Sư, Bánh Canh Yến, Mỳ Quảng Sứa Hồng Vân, Bún Chả Cá 109, and Bếp Hên the current test set for whether stronger foodie pages make the app feel more save-worthy without forcing a premature drop decision.
...
Expansion mode has now been proven twelve times for Mặn Mòi, Bò Kho Gánh, Bún Bò Huế 14B, Phở Lệ, Bánh Cuốn Bà Hoành, Bún Riêu Cua 39, Phở Gà Nguyệt, Phở 10 Lý Quốc Sư, Bánh Canh Yến, Mỳ Quảng Sứa Hồng Vân, Bún Chả Cá 109, and Bếp Hên. The implemented changes widened the importer and validators to expect HCMC 104 + Hanoi 103 + Da Nang 105 / total 512, added first-class V2.2 source objects, regenerated native resources, and recorded render proof under:

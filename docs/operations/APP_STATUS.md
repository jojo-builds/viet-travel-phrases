...
- Latest exact-current physical-phone proof is pending for current app-code payload `b93edb9a6`. The most recent nearby phone proof built and installed app-code commit `0a7fb4d50`; launch was blocked because the phone was locked.

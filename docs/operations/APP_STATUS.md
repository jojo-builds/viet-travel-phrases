...
- Latest refreshed phone proof used current `main` at commit `07a2db5d8` on Jojo's replacement/new active iPhone.
...
This document does not claim a new App Store/TestFlight release. It records the repo direction and active app surface after the native-only cleanup, 2026-06-16 non-paywall merge sweep, 2026-06-16 launch-readiness bug-hunt merge, 2026-07-04 new-phone launch-readiness validation, and 2026-07-04/05 frontend QA bug hunt.

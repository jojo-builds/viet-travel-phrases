...
# SpeakLocal Calibrated 31 Example Set - Vietnam Cities V2.1

This file curates the supplied 26-entry set into primary anchors, secondary examples, revised weaker examples, and five new backlog entries.

Source boundary for this pass:

- `SpeakLocal_Editorial_Playbook_v2_1_Portable.md`
- `SpeakLocal_All_26_Example_Entries_Vietnam_Cities_V2_1.md`
- `SpeakLocal_Remaining_Screenshot_Places_Vietnam_Cities.md`
- Web source checks linked inline for the five new entries only.
...
**Pattern taught:** First-bearings market. Use a central market to orient the traveler before asking them to shop or eat.
...
**Verification flags:** Recheck current hours before publication. Vietnamese phrase QA still recommended.
...
**Pattern taught:** Expectation-setting without deflation. Tell the traveler what it really is, then why it can still work.
...
**Verification flags:** Recheck current ticketing, weather, and cable-car operating times. Vietnamese phrase QA still recommended.

...
- Keep Portugal out of runtime wiring for now.
...
- The baseline shape should stay aligned with the shared 10-scenario traveler seam unless research shows a very strong Portugal-specific reason to adjust wording or emphasis.
- Capture pronunciation, register, and European Portuguese posture honestly.

## Required outputs
Create these files:
- `research/language-pipeline/portuguese/PORTUGAL-TRAVEL-RESEARCH.md`
- `content-draft/portuguese/README.md`
...
- `.agent/tasks/T-065/result.md`
- exactly 4 review artifacts for each required review gate under `.agent/tasks/T-065/reviews/`

## What the research must cover
- destination framing: Portugal / Portuguese
- traveler-use reality, not academic grammar ordering
- politeness model and when softer or more local variants matter
- pronunciation, search posture, and European Portuguese caution for SpeakLocal surfaces
...
- concrete recommendation for what a future Portugal starter pack should include first
...
- save each pass under `.agent/tasks/T-065/reviews/gate-01-pass-01/`, `gate-02-pass-01/`, or `gate-03-pass-01/` style folders for this task
...
- verify `content-draft/portuguese/scenario-plan.json` is valid JSON
- verify the scenario plan stays consistent with the shared traveler baseline or clearly explains any Portugal-specific deviation in the notes
- verify no runtime app files were changed
- verify review evidence exists for Gate 1, Gate 2, and Gate 3 under `.agent/tasks/T-065/reviews/`
- verify the latest pass for each gate contains exactly 4 review files
- verify all 4 subagents explicitly approved advancement in the latest pass of each gate

## Definition of done
- the required output files exist
- the Portugal lane is documented as prep-only
...
Before stopping, write `.agent/tasks/T-065/result.md` with:

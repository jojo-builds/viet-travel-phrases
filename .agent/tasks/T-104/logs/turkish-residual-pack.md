# Turkish Residual Pack

## Working pass

- translated the 6 remaining practical `needs-translation` rows:
...
- reclassified the remaining social filler rows into an explicit later-only bucket:
...
- updated the Turkish prep docs so every unresolved row or bucket has an explicit reason and next owner
...
## Expected status counts after this pass

...
## Objective
Audit the current Viet app-shell purchase and locked-state surfaces with extra attention to small-screen clarity, honest upgrade framing, and purchase or restore guidance, then apply only bounded Viet-shell fixes if repo truth shows a real problem.
...
- `.agent/AUTOMATION.md`
- `.agent/tasks/T-023/spec.md`
- if present, `.agent/tasks/T-023/result.md`
- `docs/PRIORITIES.md`
- `docs/V2_BASELINE.md`
- `docs/operations/CURRENT_BLOCKERS.md`
- `docs/operations/LATEST_VALIDATION.md`
- bounded `app/family/**` Viet-specific shell and premium surfaces
...
- unrelated task folders outside `.agent/tasks/T-072/**`
...
- Prefer bounded copy, layout, or state-truth improvements over speculative redesign.
- Treat this as the clean rerun successor to blocked `T-023`.

## Required outputs
Create or update these files:
- `app/family/**` within the bounded Viet-shell purchase or locked-state scope if a real fix is justified
- `docs/operations/LATEST_VALIDATION.md`
- `.agent/tasks/T-072/logs/shell-audit.md`
- `.agent/tasks/T-072/result.md`
- exactly 4 review artifacts for each required review gate under `.agent/tasks/T-072/reviews/`
...
- verify scope stayed bounded to the Viet-shell purchase or locked-state area plus honest ops notes

## Definition of done
- Viet purchase or locked-state shell truth is either improved or more honestly documented in a bounded way
...
Before stopping, write `.agent/tasks/T-072/result.md` with the standard task result shape.

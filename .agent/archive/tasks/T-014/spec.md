...
## Title
Desktop Codex automation pilot, Italy first-wave translation pass

## Objective
Turn the italian lane from a ranked shortlist into real first-wave translation coverage.
...
- exactly 4 review artifacts under .agent/tasks/T-014/reviews/
...
- save each pass under .agent/tasks/T-014/reviews/gate-01-pass-01/, gate-02-pass-01/, or gate-03-pass-01/ style folders for this task
...
- verify review evidence exists for Gate 1, Gate 2, and Gate 3 under .agent/tasks/T-014/reviews/
...
- the italian lane has materially stronger first-wave translation coverage than before
...
- .agent/tasks/T-014/result.md states what changed, what was verified, what remains open, and whether the objective was fully met

## Required result contract
Before stopping, write .agent/tasks/T-014/result.md with:

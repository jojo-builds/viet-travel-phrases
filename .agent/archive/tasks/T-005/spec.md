...
## Title
Desktop Codex automation pilot, Turkey research plus first authoring scaffold

## Objective
Make the Turkish prep lane materially more authoring-ready, not just more documented.
This task should turn the existing Turkey / Turkish scaffold into a stronger next-step lane by producing:
- a durable Turkey / Turkish travel research synthesis
- a clear politeness / pronunciation / repair-layer stance
...
This is prep-only work. Do not wire Turkish into the runtime app.
...
- `content-draft/turkish/scenario-plan.json`
...
- `.agent/tasks/T-005/**`
- `.agent/coordination/locks.yaml`
- `research/language-pipeline/turkish/**`
...
- This task is successful only if Turkish is left more authoring-ready than it was before.
- Keep the destination-first SpeakLocal model: Turkey is the destination, Turkish is the language layer.
...
- `content-draft/turkish/README.md`
- `content-draft/turkish/source-notes.md`
- `content-draft/turkish/scenario-plan.json` only if research justifies better Turkey-specific tips or quick-phrase priorities
- `content-draft/turkish/first-wave-priority.csv`
- `content-draft/turkish/research-backlog.md`
- `.agent/tasks/T-005/result.md`
- exactly 4 review artifacts under `.agent/tasks/T-005/reviews/`
...
- destination framing: Turkey / Turkish
...
- recommendation for what the first Turkish starter pack should prioritize
- search/localization implications relevant to Turkish spelling and traveler retrieval

## Mandatory 4-subagent review gate
Before finalizing, use exactly 4 Codex subagents and save their outputs under `.agent/tasks/T-005/reviews/`.
...
- verify `content-draft/turkish/first-wave-priority.csv` exists and is non-empty
- verify `content-draft/turkish/scenario-plan.json` parses if touched
- verify exactly 4 review files exist under `.agent/tasks/T-005/reviews/`
...
- Turkish prep truth is materially stronger than before
...
- `.agent/tasks/T-005/result.md` states what changed, what was verified, what remains open, and whether the objective was fully met
...
Before stopping, write `.agent/tasks/T-005/result.md` with:

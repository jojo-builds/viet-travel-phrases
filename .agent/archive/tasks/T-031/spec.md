...
## Objective
Bring the France prep lane up to the same authoring-ready scaffold level as the stronger future-language lanes.
This task should take the existing France research/bootstrap lane and add the missing first authoring scaffold so the next French translation task can start immediately instead of redoing orientation work.
...
- France now has durable research, but it still lacks the concrete shortlist scaffolding that the stronger future lanes gained.
- This task is successful only if France becomes immediately ready for the next translation task.
- Register, pronunciation, and `tu` versus `vous` posture still need honest caution. Do not pretend those are solved.

## Required outputs
Create or update these files:
- content-draft/french/README.md
- content-draft/french/source-notes.md
- content-draft/french/scenario-plan.json only if better France-specific priorities are justified
- content-draft/french/phrase-source.csv
- content-draft/french/first-wave-priority.csv
- content-draft/french/research-backlog.md
- .agent/tasks/T-031/result.md
- exactly 4 review artifacts under .agent/tasks/T-031/reviews/
...
- register posture for English-speaking travelers, especially `tu` versus `vous` defaults
...
- verify review evidence exists for Gate 1, Gate 2, and Gate 3 under `.agent/tasks/T-031/reviews/`
...
- `.agent/tasks/T-031/result.md` states what changed, what was verified, what remains open, and whether the objective was fully met

## Required result contract
Before stopping, write .agent/tasks/T-031/result.md with:

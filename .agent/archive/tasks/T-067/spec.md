...
- `.agent/tasks/T-067/logs/regression-audit.md`
...
- exactly 4 review artifacts for each required review gate under `.agent/tasks/T-067/reviews/`
...
## Required checks
- verify the regression audit artifact exists
...
Before stopping, write `.agent/tasks/T-067/result.md` with the standard task result shape.

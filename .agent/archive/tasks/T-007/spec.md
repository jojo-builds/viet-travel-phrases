...
## Title
Desktop Codex automation pilot, Italy research plus first authoring scaffold

## Objective
Make the Italian prep lane materially more authoring-ready for an Italy-focused pack, not just more documented.
This task should turn the existing Italy / Italian scaffold into a stronger next-step lane by producing:
- a durable Italy / Italian travel research synthesis
- a clear regional/localization stance for traveler-safe Italy usage
...
This is prep-only work. Do not wire Italian into the runtime app.
...
- This task is successful only if Italian is left more authoring-ready than it was before.
- Keep the destination-first SpeakLocal model: Italy is the destination, Italian is the language layer.
...
- Keep the pack scoped to Italy rather than broad all-Italian-language generalities.
...
- `content-draft/italian/README.md`
- `content-draft/italian/source-notes.md`
- `content-draft/italian/scenario-plan.json` only if research justifies better Italy-specific tips or quick-phrase priorities
- `content-draft/italian/first-wave-priority.csv`
- `content-draft/italian/research-backlog.md`
- `.agent/tasks/T-007/result.md`
- exactly 4 review artifacts under `.agent/tasks/T-007/reviews/`
...
- destination framing: Italy / Italian
- traveler-use reality, not classroom sequencing
- regional/localization stance for Italy traveler usage
...
- recommendation for what the first Italy starter pack should prioritize
- search/localization implications relevant to Italy-targeted traveler retrieval

## Mandatory 4-subagent review gate
Before finalizing, use exactly 4 Codex subagents and save their outputs under `.agent/tasks/T-007/reviews/`.
...
- verify `content-draft/italian/first-wave-priority.csv` exists and is non-empty
- verify `content-draft/italian/scenario-plan.json` parses if touched
- verify exactly 4 review files exist under `.agent/tasks/T-007/reviews/`
...
- Italian prep truth is materially stronger than before
...
- `.agent/tasks/T-007/result.md` states what changed, what was verified, what remains open, and whether the objective was fully met
...
Before stopping, write `.agent/tasks/T-007/result.md` with:

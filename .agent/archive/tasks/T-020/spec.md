...
## Title
Desktop Codex automation pilot, Germany research and prep-only lane bootstrap

## Objective
Create the first prep-only Germany lane artifacts needed for future SpeakLocal phrase expansion without wiring Germany into the runtime app.
...
- Keep Germany out of runtime wiring for now.
...
- The baseline shape should stay aligned with the shared 10-scenario traveler seam unless research shows a very strong Germany-specific reason to adjust wording or emphasis.
...
- .agent/tasks/T-020/result.md
- exactly 4 review artifacts for each required review gate under .agent/tasks/T-020/reviews/

## What the research must cover
- destination framing: Germany / German
...
- concrete recommendation for what a future German starter pack should include first
...
- save each pass under .agent/tasks/T-020/reviews/gate-01-pass-01/, gate-02-pass-01/, or gate-03-pass-01/ style folders for this task
...
- verify content-draft/german/scenario-plan.json is valid JSON
- verify the scenario plan stays consistent with the shared traveler baseline or clearly explains any Germany-specific deviation in the notes
- verify no runtime app files were changed
- verify review evidence exists for Gate 1, Gate 2, and Gate 3 under .agent/tasks/T-020/reviews/
...
- the german lane is documented as prep-only
...
Before stopping, write .agent/tasks/T-020/result.md with:

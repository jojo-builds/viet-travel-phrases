...
## Title
Desktop Codex automation pilot, South Korea research and prep-only lane bootstrap

## Objective
Create the first prep-only South Korea lane artifacts needed for future SpeakLocal phrase expansion without wiring South Korea into the runtime app.
...
- Keep South Korea out of runtime wiring for now.
...
- The baseline shape should stay aligned with the shared 10-scenario traveler seam unless research shows a very strong South Korea-specific reason to adjust wording or emphasis.
...
- .agent/tasks/T-018/result.md
- exactly 4 review artifacts for each required review gate under .agent/tasks/T-018/reviews/

## What the research must cover
- destination framing: South Korea / Korean
...
- concrete recommendation for what a future Korean starter pack should include first
...
- save each pass under .agent/tasks/T-018/reviews/gate-01-pass-01/, gate-02-pass-01/, or gate-03-pass-01/ style folders for this task
...
- verify content-draft/korean/scenario-plan.json is valid JSON
- verify the scenario plan stays consistent with the shared traveler baseline or clearly explains any South Korea-specific deviation in the notes
- verify no runtime app files were changed
- verify review evidence exists for Gate 1, Gate 2, and Gate 3 under .agent/tasks/T-018/reviews/
...
- the korean lane is documented as prep-only
...
Before stopping, write .agent/tasks/T-018/result.md with:
